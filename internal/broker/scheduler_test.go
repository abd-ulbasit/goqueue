...
func TestScheduler_Cancel(t *testing.T) {
	// WHAT: Cancelling a scheduled message
	...
	if scheduler.IsDelayed("test-topic", 0, 100) {
		t.Error("cancelled message should not be delayed")
	}
}

func TestScheduler_CancelNonExistent(t *testing.T) {
	// WHAT: Cancelling non-existent message
	...
	if err == nil {
		t.Error("expected error cancelling non-existent message")
	}
}

func TestScheduler_CancelPreventsDelivery(t *testing.T) {
	// WHAT: Cancelled messages don't get delivered
	...
	if delivered.Load() {
		t.Error("cancelled message should not be delivered")
	}
}

...
const (
	TransactionService_InitProducer_FullMethodName        = "/goqueue.v1.TransactionService/InitProducer"
	TransactionService_BeginTransaction_FullMethodName    = "/goqueue.v1.TransactionService/BeginTransaction"
	TransactionService_AddPartition_FullMethodName        = "/goqueue.v1.TransactionService/AddPartition"
	TransactionService_CommitTransaction_FullMethodName   = "/goqueue.v1.TransactionService/CommitTransaction"
	TransactionService_AbortTransaction_FullMethodName    = "/goqueue.v1.TransactionService/AbortTransaction"
	TransactionService_ListTransactions_FullMethodName    = "/goqueue.v1.TransactionService/ListTransactions"
	TransactionService_DescribeTransaction_FullMethodName = "/goqueue.v1.TransactionService/DescribeTransaction"
)
...
type TransactionServiceClient interface {
	...
	// (zombie fencing).
	InitProducer(ctx context.Context, in *InitProducerRequest, opts ...grpc.CallOption) (*InitProducerResponse, error)
...
func (c *transactionServiceClient) InitProducer(ctx context.Context, in *InitProducerRequest, opts ...grpc.CallOption) (*InitProducerResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(InitProducerResponse)
	err := c.cc.Invoke(ctx, TransactionService_InitProducer_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transactionServiceClient) AddPartition(ctx context.Context, in *AddPartitionRequest, opts ...grpc.CallOption) (*AddPartitionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AddPartitionResponse)
	err := c.cc.Invoke(ctx, TransactionService_AddPartition_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *transactionServiceClient) DescribeTransaction(ctx context.Context, in *DescribeTransactionRequest, opts ...grpc.CallOption) (*DescribeTransactionResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DescribeTransactionResponse)
	err := c.cc.Invoke(ctx, TransactionService_DescribeTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TransactionServiceServer interface {
	...
	// and epoch. If the transactional ID was used before, the epoch is bumped
	// (zombie fencing).
	InitProducer(context.Context, *InitProducerRequest) (*InitProducerResponse, error)
	// BeginTransaction starts a new transaction for the given producer.
...
func (UnimplementedTransactionServiceServer) InitProducer(context.Context, *InitProducerRequest) (*InitProducerResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method InitProducer not implemented")
}
...
func (UnimplementedTransactionServiceServer) AddPartition(context.Context, *AddPartitionRequest) (*AddPartitionResponse, error) {
...
func (UnimplementedTransactionServiceServer) DescribeTransaction(context.Context, *DescribeTransactionRequest) (*DescribeTransactionResponse, error) {
...
func _TransactionService_InitProducer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InitProducerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionServiceServer).InitProducer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionService_InitProducer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionServiceServer).InitProducer(ctx, req.(*InitProducerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TransactionService_AddPartition_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AddPartitionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionServiceServer).AddPartition(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionService_AddPartition_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionServiceServer).AddPartition(ctx, req.(*AddPartitionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _TransactionService_DescribeTransaction_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DescribeTransactionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TransactionServiceServer).DescribeTransaction(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TransactionService_DescribeTransaction_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TransactionServiceServer).DescribeTransaction(ctx, req.(*DescribeTransactionRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TransactionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "goqueue.v1.TransactionService",
	HandlerType: (*TransactionServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "InitProducer",
			Handler:    _TransactionService_InitProducer_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _TransactionService_AddPartition_Handler,
		},
		{
		...
		},
		{
			...
			Handler:    _TransactionService_DescribeTransaction_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "goqueue.proto",
